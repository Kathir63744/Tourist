...
export default function BlogPage() {
  ...
  return (
    <>
      {/* ✅ Head with metadata and canonical tag */}
      <Head>
        <title>Travel Blog - Valparai, Solaiyur & Kothagiri | Zoy Tours</title>
        <meta 
          name="description" 
          content="Discover travel guides, tips, and stories from Valparai, Solaiyur & Kothagiri. Explore hill station experiences, local cuisine, and hidden gems in Tamil Nadu's Western Ghats." 
        />
        <link rel="canonical" href={`${SITE_URL}/blog`} />
        
        {/* Open Graph */}
        <meta property="og:title" content="Travel Blog - Valparai, Solaiyur & Kothagiri | Zoy Tours" />
        <meta 
          property="og:description" 
          content="Discover travel guides, tips, and stories from Valparai, Solaiyur & Kothagiri. Explore hill station experiences and hidden gems." 
        />
        <meta property="og:url" content={`${SITE_URL}/blog`} />
        <meta property="og:type" content="website" />
        <meta property="og:site_name" content="Zoy Tours" />
        <meta property="og:image" content={`${SITE_URL}/og-blog.jpg`} />
        ...
        <meta name="twitter:title" content="Travel Blog - Valparai, Solaiyur & Kothagiri | Zoy Tours" />
        <meta 
          name="twitter:description" 
          content="Discover travel guides, tips, and stories from Valparai, Solaiyur & Kothagiri." 
        />
        <meta name="twitter:image" content={`${SITE_URL}/og-blog.jpg`} />
        <meta name="twitter:site" content="@zoytours" />
        <meta name="twitter:creator" content="@zoytours" />
        ...
        <meta 
          name="keywords" 
          content="Valparai blog, Kothagiri travel, hill station guide, Valparai travel tips, Kothagiri experiences, Western Ghats blog, travel stories, resort reviews, Valparai tourism, Kothagiri tourism" 
        />
        
        {/* Additional SEO */}
        <meta name="author" content="Zoy Tours Team" />
                ...
                <div className="mb-6">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {locations.map(location => (
                      ...
                      >
                        {location === 'Valparai-Sholayar' && <Home className="w-4 h-4" />}
                    ...
                    <div className="flex flex-wrap gap-2">
                      {selectedLocation !== "All" && (
                        <span className="inline-flex items-center gap-1 px-3 py-1 bg-teal-500/20 text-teal-300 rounded-full text-sm">
                          {selectedLocation === 'Valparai-Sholayar' && <Home className="w-3 h-3" />}
