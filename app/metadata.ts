...
export const homepageMetadata: Metadata = {
  title: 'HillEscape - Premium Hill Station Resorts in Valparai & Kothagiri',
  ...
  openGraph: {
    title: 'HillEscape - Premium Hill Station Resorts',
    description: 'Book luxury hill station resorts in Valparai & Kothagiri. Best price guaranteed.',
    url: '/',
    images: [{ url: '/og-home.jpg', width: 1200, height: 630, alt: 'HillEscape Resorts' }],
  },
  twitter: {
